...
def test_prepare_alerts_for_map_basic():
    ...
    df = pd.DataFrame(
        [
            {"timestamp": "2026-02-03T10:00:00", "src_ip": "1.1.1.1", "lat": 37.7749, "lon": -122.4194, "confidence": 90},
            {"timestamp": "2026-02-03T11:00:00", "src_ip": "2.2.2.2", "lat": 51.5074, "lon": -0.1278, "confidence": 75},
        ]
    )
